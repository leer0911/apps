 ...
 */
export const APPSMITH_DISPLAY_VERSION = (edition: string, version: string) => `Appsmith ${edition} ${version}`;
export const INTERCOM_CONSENT_MESSAGE = () => `Can we have your email for better support?`;
export const YES = () => `Yes`;
export const ARE_YOU_SURE = () => `Are you sure?`;
export const CHAT_WITH_US = () => `Chat with us`;
export const ERROR_ADD_API_INVALID_URL = () => `Unable to create API. Try adding a URL to the datasource`;
export const ERROR_MESSAGE_NAME_EMPTY = () => `Please select a name`;
export const ERROR_MESSAGE_CREATE_APPLICATION = () => `We could not create the Application`;
...
export const INPUT_TEXT_MAX_CHAR_ERROR = (max: number) => `Input text length must be less than ${max} characters`;
export const INPUT_DEFAULT_TEXT_MAX_NUM_ERROR = () => `Default Text value must be less than Max number allowed`;
export const INPUT_DEFAULT_TEXT_MIN_NUM_ERROR = () => `Default Text value must be greater than Min number allowed`;
export const INPUT_INVALID_TYPE_ERROR = () => `Type Mismatch. Please enter a valid value`;
export const VALID_FUNCTION_NAME_ERROR = () => `Must be a valid variable name (camelCase)`;
...
export const FORM_VALIDATION_INVALID_EMAIL = () => `Please provide a valid email address`;
...
export const FORM_VALIDATION_PASSWORD_RULE = () => `Please provide a password between 8 and 48 characters`;
...
export const LOGIN_PAGE_PASSWORD_INPUT_PLACEHOLDER = () => `Enter your password`;
...
export const SIGNUP_PAGE_PASSWORD_INPUT_PLACEHOLDER = () => `Enter your password`;
...
export const RESET_PASSWORD_PAGE_SUBTITLE = () => `Create a new password for your account `;
...
export const FORGOT_PASSWORD_PAGE_EMAIL_INPUT_PLACEHOLDER = () => `Enter your email`;
export const FORGOT_PASSWORD_PAGE_TITLE = () => `Reset password`;
export const FORGOT_PASSWORD_PAGE_SUB_TITLE = () => `Enter the email address associated with your account`;
export const FORGOT_PASSWORD_PAGE_SUBTITLE = () => `We will send a reset link to the email below`;
...
export const VERIFICATION_PENDING_NO_EMAIL = () => `No email in your inbox or spam folder?`;

export const VERIFICATION_PENDING_RESEND_LINK = () => `Resend link`;

export const VERIFY_ERROR_ALREADY_VERIFIED_TITLE = () => `Email already verified`;

export const VERIFY_ERROR_EXPIRED_TITLE = () => 'Oops, this link has expired';

export const VERIFY_ERROR_MISMATCH_TITLE = () => 'This link seems damaged. Please request a new link';
...
export const PAGE_NOT_FOUND_ERROR = () => `The page you’re looking for either does not exist, or cannot be found`;
...
export const INVITE_USERS_VALIDATION_EMAILS_EMPTY = () => `Please enter the user emails`;
...
export const CUSTOM_ROLES_RAMP_TEXT = () => 'To build and assign custom roles, try out our ';
...
export const USERS_HAVE_ACCESS_TO_ALL_APPS = () => 'Users will have access to all applications in this workspace';
export const USERS_HAVE_ACCESS_TO_ONLY_THIS_APP = () => 'Users will only have access to this application';
...
export const PARTNER_PROGRAM_CALLOUT_LINK = () => `Learn about Appsmith Partner Program`;
export const NEW_APPLICATION = () => `New application`;
export const APPLICATIONS = () => `Applications`;

export const USER_PROFILE_PICTURE_UPLOAD_FAILED = () => 'Unable to upload display picture.';
export const UPDATE_USER_DETAILS_FAILED = () => 'Unable to update user details.';
export const USER_DISPLAY_PICTURE_FILE_INVALID = () => "File content doesn't seem to be an image. Please verify.";
export const USER_DISPLAY_NAME_CHAR_CHECK_FAILED = () => "No special characters allowed except .'-";
...
export const ADD_API_TO_PAGE_SUCCESS_MESSAGE = (actionName: string) => `${actionName} API added to page`;
...
export const NO_APPS_FOUND = () => `Whale! Whale! This name doesn't ring a bell!`;
export const APPLICATION_CARD_LIST_ZERO_STATE = () => `There are no applications in this workspace.`;
...
export const CHECK_REQUEST_BODY = () => `Please check your request configuration to debug`;
export const DONT_SHOW_THIS_AGAIN = () => `Don't show this again`;

export const TABLE_FILTER_COLUMN_TYPE_CALLOUT = () => `Change column datatype to see filter operators`;

export const SAVE_HOTKEY_TOASTER_MESSAGE = () => "Don't worry about saving, we've got you covered!";

export const WIDGET_SIDEBAR_TITLE = () => `Widgets`;
export const WIDGET_SIDEBAR_CAPTION = () => `Drag a widget and drop it on the canvas`;
...
export const ERROR_FILE_TOO_LARGE = (fileSize: string) => `File size should be less than ${fileSize}!`;
export const ERROR_DATEPICKER_MIN_DATE = () => `Min date cannot be greater than current widget value`;
export const ERROR_DATEPICKER_MAX_DATE = () => `Min date cannot be greater than current widget value`;
export const ERROR_WIDGET_DOWNLOAD = (err: string) => `Download failed. ${err}`;
export const ERROR_PLUGIN_ACTION_EXECUTE = (actionName: string) => `${actionName} failed to execute`;
export const ACTION_EXECUTION_CANCELLED = (actionName: string) => `${actionName} was cancelled`;
export const ERROR_FAIL_ON_PAGE_LOAD_ACTIONS = () => `Failed to execute actions during page load`;
export const ERROR_ACTION_EXECUTE_FAIL = (actionName: string) => `${actionName} action returned an error response`;
export const ACTION_MOVE_SUCCESS = (actionName: string, pageName: string) =>
  `${actionName} action moved to page ${pageName} successfully`;
export const ERROR_ACTION_MOVE_FAIL = (actionName: string) => `Error while moving action ${actionName}`;
export const ACTION_COPY_SUCCESS = (actionName: string, pageName: string) =>
  `${actionName} action copied to page ${pageName} successfully`;
export const ERROR_ACTION_COPY_FAIL = (actionName: string) => `Error while copying action ${actionName}`;
export const ERROR_ACTION_RENAME_FAIL = (actionName: string) => `Unable to update action name to ${actionName}`;

// Action Names Messages
export const ACTION_NAME_PLACEHOLDER = (type: string) => `Name of the ${type} in camelCase`;
export const ACTION_INVALID_NAME_ERROR = () => 'Please enter a valid name';
export const ACTION_NAME_CONFLICT_ERROR = (name: string) => `${name} is already being used or is a restricted keyword.`;
export const ENTITY_EXPLORER_ACTION_NAME_CONFLICT_ERROR = (name: string) => `${name} is already being used.`;

export const ACTION_ID_NOT_FOUND_IN_URL = 'No correct API id or Query id found in the url.';
export const JSOBJECT_ID_NOT_FOUND_IN_URL = 'No correct JS Object id found in the url.';

export const DATASOURCE_CREATE = (dsName: string) => `${dsName} datasource created`;
export const DATASOURCE_DELETE = (dsName: string) => `${dsName} datasource deleted successfully`;
export const DATASOURCE_UPDATE = (dsName: string) => `${dsName} datasource updated successfully`;
export const DATASOURCE_VALID = (dsName: string) => `${dsName} datasource is valid`;
export const EDIT_DATASOURCE = () => 'Edit datasource';
export const SAVE_DATASOURCE = () => 'Save as datasource';
export const SAVE_DATASOURCE_MESSAGE = () => 'Save the URL as a datasource to access authentication settings';
export const EDIT_DATASOURCE_MESSAGE = () => 'Edit datasource to access authentication settings';
...
export const NO_DATASOURCE_FOR_QUERY = () => `Seems like you don’t have any Datasources to create a query`;
...
export const ACTION_RUN_BUTTON_MESSAGE_SECOND_HALF = () => 'after adding your query';
...
export const ERROR_EVAL_ERROR_GENERIC = () => `Unexpected error occurred while evaluating the application`;

export const ERROR_EVAL_TRIGGER = (message: string) => `Error occurred while evaluating trigger: ${message}`;

export const WIDGET_COPY = (widgetName: string) => `Copied ${widgetName}`;
export const ERROR_WIDGET_COPY_NO_WIDGET_SELECTED = () => `Please select a widget to copy`;
export const ERROR_WIDGET_COPY_NOT_ALLOWED = () => `This selected widget cannot be copied.`;
export const WIDGET_CUT = (widgetName: string) => `Cut ${widgetName}`;
export const ERROR_WIDGET_CUT_NO_WIDGET_SELECTED = () => `Please select a widget to cut`;
export const ERROR_WIDGET_CUT_NOT_ALLOWED = () => `This selected widget cannot be cut.`;
export const SELECT_ALL_WIDGETS_MSG = () => `All widgets in this page including modals have been selected`;
export const ERROR_ADD_WIDGET_FROM_QUERY = () => `Failed to add widget`;

export const REST_API_AUTHORIZATION_SUCCESSFUL = () => 'Authorization was successful!';
export const REST_API_AUTHORIZATION_FAILED = () => 'Authorization failed. Please check your details or try again.';
...
export const OAUTH_AUTHORIZATION_FAILED = 'Authorization failed. Please check your details or try again.';
// Todo: improve this for appsmith_error error message
...
export const GSHEET_AUTHORIZATION_ERROR = 'Authorisation failed, to continue using this data source authorize now.';
...
export const OMNIBAR_PLACEHOLDER = () => `Search widgets, queries or create new`;
export const OMNIBAR_PLACEHOLDER_NAV = () => 'Search widgets and queries';
export const CREATE_NEW_OMNIBAR_PLACEHOLDER = () => 'Create a new query, API or JS Object';
export const HELPBAR_PLACEHOLDER = () => 'Search';
export const NO_SEARCH_DATA_TEXT = () => 'No results found';

export const WIDGET_BIND_HELP = () => 'Having trouble taking inputs from widgets?';
...
export const PAGE_SERVER_TIMEOUT_TITLE = () => 'Appsmith server is taking too long to respond';
export const PAGE_SERVER_TIMEOUT_DESCRIPTION = () => `Please retry after some time`;
export const PAGE_CLIENT_ERROR_TITLE = () => 'Whoops something went wrong!';
export const PAGE_CLIENT_ERROR_DESCRIPTION = () => 'This is embarrassing, please contact Appsmith support for help';

export const PAGE_SERVER_UNAVAILABLE_ERROR_CODE = () => '503';

// cloudHosting used in EE
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export const PAGE_SERVER_UNAVAILABLE_TITLE = () => 'Appsmith server unavailable';

export const PAGE_SERVER_UNAVAILABLE_DESCRIPTION = () => 'Please try again later';

export const PAGE_SERVER_UNAVAILABLE_ERROR_MESSAGES = (cloudHosting: boolean): PageErrorMessageProps[] => {
  if (cloudHosting) {
    return [
      {
...
export const DEBUGGER_QUERY_RESPONSE_SECOND_HALF = () => ' to see more info in the debugger';
...
export const VALUE_IS_INVALID = (propertyPath: string) => `The value at ${propertyPath} is invalid`;
...
export const EMPTY_JS_RESPONSE_LAST_HALF = () => 'to view response of selected function';
...
export const ERROR_JS_ACTION_COPY_FAIL = (actionName: string) => `Error while copying ${actionName}`;
export const JS_ACTION_DELETE_SUCCESS = (actionName: string) => `${actionName} deleted successfully`;
export const JS_ACTION_MOVE_SUCCESS = (actionName: string, pageName: string) =>
  `${actionName} moved to page ${pageName} successfully`;
export const ERROR_JS_ACTION_MOVE_FAIL = (actionName: string) => `Error while moving ${actionName}`;
export const ERROR_JS_COLLECTION_RENAME_FAIL = (actionName: string) =>
  `Unable to update JS collection name to ${actionName}`;
export const PARSE_JS_FUNCTION_ERROR = (message: string) => `Syntax error: ${message}`;

export const EXECUTING_FUNCTION = () => `Executing function`;
export const UPDATING_JS_COLLECTION = () => `Updating...`;
export const EMPTY_JS_OBJECT = () => `Nothing to show, write some code to get response`;
export const EXPORT_DEFAULT_BEGINNING = () => `Start object with export default`;
export const ACTION_EXECUTION_FAILED = (actionName: string) => `The action "${actionName}" has failed.`;
...
export const JS_EXECUTION_FAILURE_TOASTER = () => 'There was an error while executing function';
export const JS_SETTINGS_ONPAGELOAD = () => 'Run function on page load (Beta)';
export const JS_SETTINGS_ONPAGELOAD_SUBTEXT = () => 'Will refresh data every time page is reloaded';
export const JS_SETTINGS_CONFIRM_EXECUTION = () => 'Request confirmation before calling function?';
export const JS_SETTINGS_CONFIRM_EXECUTION_SUBTEXT = () =>
  'Ask confirmation from the user every time before refreshing data';
export const JS_SETTINGS_EXECUTE_TIMEOUT = () => 'Function timeout (in milliseconds)';
...
export const NO_JS_FUNCTION_TO_RUN = (JSObjectName: string) => `${JSObjectName} has no function`;
...
export const REMOVE_CONFIRM_BEFORE_CALLING_HEADING = () => `Remove 'Confirm before calling' `;
...
export const ERROR_IMPORTING_APPLICATION_TO_WORKSPACE = () => 'Error importing application. No workspace found';
export const IMPORT_APPLICATION_MODAL_TITLE = () => 'Import application';
export const IMPORT_APPLICATION_MODAL_LABEL = () => 'Where would you like to import your application from?';
...
export const IMPORT_APP_FROM_GIT_TITLE = () => 'Import from Git repository (Beta)';
export const IMPORT_APP_FROM_FILE_MESSAGE = () => 'Drag and drop your file or upload from your computer';
export const IMPORT_APP_FROM_GIT_MESSAGE = () => 'Import an application from its Git repository using its SSH URL';
export const IMPORT_FROM_GIT_REPOSITORY = () => 'Import from Git repository';
export const RECONNECT_MISSING_DATASOURCE_CREDENTIALS = () => 'Reconnect missing datasource credentials';
...
export const RECONNECT_DATASOURCE_SUCCESS_MESSAGE1 = () => 'These datasources were imported successfully!';
export const RECONNECT_DATASOURCE_SUCCESS_MESSAGE2 = () => 'Please fill up the missing datasources';
export const ADD_MISSING_DATASOURCES = () => 'Add missing datasources';
export const SKIP_TO_APPLICATION_TOOLTIP_HEADER = () => 'This action is irreversible.';
export const SKIP_TO_APPLICATION_TOOLTIP_DESCRIPTION = () => `Skip this step to configure datasources later`;
export const SKIP_TO_APPLICATION = () => 'Go to application';
export const SKIP_CONFIGURATION = () => 'Skip configuration';
export const SELECT_A_METHOD_TO_ADD_CREDENTIALS = () => 'Select a method to add credentials';
export const DELETE_CONFIRMATION_MODAL_TITLE = () => `Are you sure?`;
export const DELETE_CONFIRMATION_MODAL_SUBTITLE = (name?: string | null, entityType?: string) =>
  `You want to remove ${name} from this ${entityType === 'Application' ? 'application' : 'workspace'}`;
export const PARSING_ERROR = () => 'Syntax error: Unable to parse code, please check error logs to debug';
export const PARSING_WARNING = () => 'Linting errors: Please resolve linting errors before using these functions';
export const JS_FUNCTION_CREATE_SUCCESS = () => 'New JS function added successfully';
export const JS_FUNCTION_UPDATE_SUCCESS = () => 'JS Function updated successfully';
export const JS_FUNCTION_DELETE_SUCCESS = () => 'JS function deleted successfully';
...
//undo redo
export const WIDGET_REMOVED = (widgetName: string) => `${widgetName} is removed`;
export const WIDGET_ADDED = (widgetName: string) => `${widgetName} is added back`;
export const BULK_WIDGET_REMOVED = (widgetName: string) => `${widgetName} widgets are removed`;
export const BULK_WIDGET_ADDED = (widgetName: string) => `${widgetName} widgets are added back`;

export const ACTION_CONFIGURATION_CHANGED = (name: string) => `${name}'s configuration has changed`;

// Generate page from DB Messages

export const UNSUPPORTED_PLUGIN_DIALOG_TITLE = () => `We could not auto-generate a page from this Datasource`;

export const UNSUPPORTED_PLUGIN_DIALOG_SUBTITLE = () =>
  `You can continue building your app with it using our drag & drop builder`;
export const UNSUPPORTED_PLUGIN_DIALOG_MAIN_HEADING = () => `Issue with auto generation`;

export const BUILD_FROM_SCRATCH_ACTION_SUBTITLE = () => 'Start from scratch and create your custom UI';
...
export const GEN_CRUD_SUCCESS_MESSAGE = () => 'Hurray! Your application is ready for use.';
...
export const GEN_CRUD_TABLE_HEADER_TOOLTIP_DESC = () => 'Row index of the column headers in the sheet table';
// Actions Right pane
...
export const SUGGESTED_WIDGET_DESCRIPTION = () => 'This will add a new widget to the canvas.';
...
export const ADD_NEW_WIDGET_SUB_HEADING = () => 'Select how you want to display data.';
export const CONNECT_EXISTING_WIDGET_LABEL = () => 'Select a widget';
export const CONNECT_EXISTING_WIDGET_SUB_HEADING = () => 'Replace the data of an existing widget';
...
export const BINDINGS_DISABLED_TOOLTIP = () => 'You can display data when you have a successful response to your query';
...
export const DATASOURCE_STRUCTURE_INPUT_PLACEHOLDER_TEXT = (name: string) => `Tables in ${name}`;
export const SCHEMA_LABEL = () => 'Schema';
export const STRUCTURE_NOT_FETCHED = () => 'We could not fetch the schema of the database.';
export const TEST_DATASOURCE_AND_FIX_ERRORS = () => 'Test the datasource and fix the errors.';
...
export const GIT_DISCONNECT_POPUP_TITLE = () => `This will disconnect the Git repository from this application`;

export const GIT_DISCONNECT_POPUP_SUBTITLE = () => `Git features will no more be shown for this application`;
...
export const CONNECT_TO_GIT_SUBTITLE = () => 'Checkout branches, make commits, and deploy your application';
export const REMOTE_URL = () => 'Remote URL';
export const REMOTE_URL_INFO = () => `Create an empty Git repository and paste the remote URL here.`;
...
export const AUTHOR_EMAIL_CANNOT_BE_EMPTY = () => 'Author email cannot be empty';
...
export const DEPLOY_WITHOUT_GIT = () => 'Deploy your application without version control';
...
export const REGENERATE_SSH_KEY = (keyType: string, keySize: number) => `Regenerate ${keyType} ${keySize} key`;
export const GENERATE_SSH_KEY = (keyType: string, keySize: number) => `${keyType} ${keySize} key`;
...
export const COMMITTING_AND_PUSHING_CHANGES = () => 'Committing and pushing changes...';
export const DISCARDING_AND_PULLING_CHANGES = () => 'Discarding and pulling changes...';
...
export const GIT_USER_UPDATED_SUCCESSFULLY = () => 'Git user updated successfully';
export const REMOTE_URL_INPUT_PLACEHOLDER = () => 'git@example.com:user/repository.git';
...
export const PASTE_SSH_URL_INFO = () => 'Please enter a valid SSH URL of your repository';
...
export const NO_MERGE_CONFLICT = () => 'This branch has no conflicts with the base branch.';
...
export const GIT_CONFLICTING_INFO = () => 'Please resolve the merge conflicts manually on your repository.';
...
export const DISCONNECT_SERVICE_WARNING = () => 'will be removed as primary method of authentication';
export const AUTHENTICATION_METHOD_ENABLED = (methodName: string) => `
  ${methodName} authentication is enabled
`;

export const REVOKE_EXISTING_REPOSITORIES = () => 'Revoke existing repositories';
...
export const APPLICATION_IMPORT_SUCCESS = () => `Your application is ready to use.`;
export const APPLICATION_IMPORT_SUCCESS_DESCRIPTION = () => 'All your datasources are configured and ready to use.';
export const NONE_REVERSIBLE_MESSAGE = () => 'This action is non-reversible. Please proceed with caution.';
...
export const REVOKE_CAUSE_APPLICATION_BREAK = () => 'Revoking your repository might cause the application to break.';
...
export const DISCONNECT_FROM_GIT = (name: string) => `Disconnect ${name} from Git`;
...
export const CONFIRM_SSH_KEY = () => 'Please make sure your SSH key has write access.';
...
export const CONFLICTS_FOUND = () => 'Conflicts found. Please resolve them and pull again.';
export const UNCOMMITTED_CHANGES = () => 'You have uncommitted changes';
export const NO_COMMITS_TO_PULL = () => 'No commits to pull. This branch is in sync with the remote repository';
export const CONFLICTS_FOUND_WHILE_PULLING_CHANGES = () => 'Conflicts found while pulling changes.';
export const NOT_LIVE_FOR_YOU_YET = () => "It's not live for you yet";
export const COMING_SOON = () => 'Coming Soon!';
export const CONNECTING_TO_REPO_DISABLED = () => 'Connecting to a Git repository is disabled';
...
export const CHANGES_SINCE_LAST_DEPLOYMENT = () => 'Changes since last deployment';
export const CHANGES_ONLY_USER = () => 'Changes since last commit';
export const CHANGES_MADE_SINCE_LAST_COMMIT = () => 'Changes made since last commit';
export const CHANGES_ONLY_MIGRATION = () => 'Appsmith update changes since last commit';
export const CHANGES_USER_AND_MIGRATION = () => 'Appsmith update and user changes since last commit';
export const CURRENT_PAGE_DISCARD_WARNING = (page: string) => `Current page (${page}) is in the discard list.`;
...
export const CHANGES_FROM_APPSMITH = () => 'Some changes are platform upgrades from Appsmith.';
export const TRY_TO_PULL = () => 'We will try to pull before pushing your changes.';
export const NOT_PUSHED_YET = () => "These are the commits that haven't been pushed to remote yet.";
// GIT CHANGE LIST end
...
export const DELETE_BRANCH_SUCCESS = (branchName: string) => `Successfully deleted branch: ${branchName}`;
...
export const ERROR_GIT_INVALID_REMOTE = () => "Either the remote repository doesn't exist or is unreachable.";
// GIT ERRORS end
...
export const CHOOSE_GIT_PROVIDER_QUESTION = () => 'To begin with, choose your Git service provider';
export const IS_EMPTY_REPO_QUESTION = () => 'Do you have an existing empty repository to connect to Git?';
...
export const I_HAVE_EXISTING_REPO = () => 'I have an existing appsmith app connected to Git';
export const ERROR_REPO_NOT_EMPTY_TITLE = () => "The repo you added isn't empty";
...
export const HOW_TO_COPY_REMOTE_URL = () => 'How to copy & paste SSH remote URL';
...
export const ADD_DEPLOY_KEY_STEP_TITLE = () => 'Add deploy key & give write access';
export const HOW_TO_ADD_DEPLOY_KEY = () => 'How to paste SSH Key in repo and give write access?';
export const CONSENT_ADDED_DEPLOY_KEY = () => "I've added the deploy key and gave it write access";
export const PREVIOUS_STEP = () => 'Previous step';
export const GIT_CONNECT_SUCCESS_TITLE = () => 'Successfully connected to your Git remote repository';
...
export const AUTOCOMMIT_MESSAGE = () => 'Enable/disable auto migrations from Appsmith.';
...
export const AUTOCOMMIT_IN_PROGRESS_MESSAGE = () => 'Auto-committing Appsmith upgrade changes...';
export const AUTOCOMMIT_ENABLED_TOAST = () => 'Auto-commit enabled successfully';
export const AUTOCOMMIT_DISABLED_TOAST = () => 'Auto-commit disabled successfully';
...
export const GIT_IMPORT_WAITING = () => 'Please wait while we import the app...';
export const GIT_CONNECT_WAITING = () => 'Please wait while we connect to Git...';
...
export const ERROR_SSH_RECONNECT_OPTION1 = () => 'Copy the SSH key below and add it to your repository.';
...
export const BRANCH_PROTECTION_RULES_AS_FOLLOWS = () => 'Branch protection rules follow as,';
export const BRANCH_PROTECTION_RULE_1 = () => 'Commit and merge are not allowed.';
export const BRANCH_PROTECTION_RULE_2 = () => 'Users can’t create or edit queries, widgets, and JS Objects.';
export const BRANCH_PROTECTION_RULE_3 = () =>
  'You can still pull the latest changes and create new branches to edit the app.';
export const BRANCH_PROTECTION_CHANGE_RULE = () => 'You can remove protection on your default branch in Git settings.';
export const GO_TO_SETTINGS = () => 'Go to settings';
export const NOW_PROTECT_BRANCH = () => 'You can now protect your default branch.';
...
export const CONTACT_ADMIN_FOR_GIT = () => 'Please contact your workspace admin to connect your app to a git repo';
...
export const BRANCH_PROTECTION_CALLOUT_CREATE_BRANCH = () => 'Create new branch';
export const BRANCH_PROTECTION_CALLOUT_UNPROTECT = () => 'Unprotect branch';
export const BRANCH_PROTECTION_CALLOUT_UNPROTECT_LOADING = () => 'Unprotecting branch ...';
...
export const NAV_DESCRIPTION = () => `Navigate to any page, widget or file across this project.`;
export const ACTION_OPERATION_DESCRIPTION = () => `Create a new query, API or JS Object`;
export const TABLE_WIDGET_VALIDATION_ASSIST_PROMPT = () => `Access the current cell using `;
...
export const SNIPING_SELECT_WIDGET_AGAIN = () => 'Unable to detect the widget, please select the widget again.';

export const SNIPING_NOT_SUPPORTED = () => 'Binding on selection is not supported for this type of widget!';
...
export const ONBOARDING_CHECKLIST_BANNER_HEADER = () => 'Amazing work! You’ve explored the basics of Appsmith';
...
export const ONBOARDING_SKIPPED_FIRST_TIME_USER = () => 'Skipped onboarding tour';
...
export const SIGNPOSTING_POPUP_SUBTITLE = () => 'Here’s what you need to do to build your first app:';
...
export const SIGNPOSTING_TOOLTIP = {
  ...
  CONNECT_DATA_TO_WIDGET: {
    content: () => 'That was easy. Connect the query you wrote in Step 2 to present data in this widget.',
  },
  DEPLOY_APPLICATION: {
    content: () => 'Deploy your app to see it live and share it with your users.',
  },
  DOCUMENTATION: {
...
export const ONBOARDING_CHECKLIST_FOOTER = () => 'Not sure where to start? Take the welcome tour';
...
//Introduction modal
export const HOW_APPSMITH_WORKS = () => 'Here’s a quick overview of how Appsmith works. ';
export const ONBOARDING_INTRO_CONNECT_YOUR_DATABASE = () => 'Connect to your database or APIs';
export const DRAG_AND_DROP = () => 'Drag and drop pre-built widgets to build UI';
...
export const ONBOARDING_INTRO_PUBLISH = () => 'Publish & Share with permissions';
...
export const ONBOARDING_INTRO_FOOTER = () => 'Let’s start building your first application';
...
export const ONBOARDING_STATUS_STEPS_FOURTH = () => 'Next, connect data to widget';
export const ONBOARDING_STATUS_STEPS_FIVETH = () => 'Next, deploy your application';
export const ONBOARDING_STATUS_STEPS_SIXTH = () => 'Completed 🎉';
export const ONBOARDING_STATUS_GET_STARTED = () => 'Get started';

//Tasks
//1. datasource
export const ONBOARDING_TASK_DATASOURCE_HEADER = () => 'Start by adding your first datasource';
...
//2. widget
export const ONBOARDING_TASK_WIDGET_HEADER = () => 'Next, add a widget to start displaying data';
...
export const ONBOARDING_TASK_WIDGET_FOOTER_ACTION = () => 'deploy your application';
...
export const PRODUCT_UPDATES_CONFIRMATION_LABEL = () => 'I accept receiving security and product updates';
...
export const ACTION_EXECUTION_MESSAGE = (actionType: string) => `Sending the ${actionType} request`;
...
export const WELCOME_FORM_DATA_COLLECTION_HEADER = () => 'Usage data preference';
export const WELCOME_FORM_DATA_COLLECTION_BODY = () => 'Share anonymous usage data to help improve the product.';
export const WELCOME_FORM_DATA_COLLECTION_LINK = () => 'See what is shared';
export const WELCOME_FORM_DATA_COLLECTION_LABEL_ENABLE = () => 'Share data & make Appsmith better!';
export const WELCOME_FORM_DATA_COLLECTION_LABEL_DISABLE = () => "Don't share any data";
export const WELCOME_FORM_NEWLETTER_HEADER = () => 'Stay in touch';
export const WELCOME_FORM_NEWLETTER_LABEL = () => 'Get updates about what we are cooking. We will not spam you.';
...
export const ADD_DATASOURCE_TOOLTIP = () => 'Add datasource or create new query';
...
export const LAYOUT_DROPDOWN_TOOLTIP = () => 'Choose how your application looks on desktop, tablet and mobile devices';
export const DEPLOY_BUTTON_TOOLTIP = () => 'Deploy the current version of the application';
export const SHARE_BUTTON_TOOLTIP = () => 'Invite your team to Appsmith';
export const SHARE_BUTTON_TOOLTIP_WITH_USER = (length: number) => () => `Shared with ${length} other`;
...
export const RESTART_BANNER_BODY = () => 'Hang in there. This should be done soon.';
export const RESTART_BANNER_HEADER = () => 'Restarting your server';
export const RESTART_ERROR_BODY = () => 'You can try restarting the server again for the settings to take place.';
...
export const TEST_EMAIL_SUCCESS = (email: string) => () => `Test email sent, please check the inbox of ${email}`;
...
export const DISCONNECT_AUTH_ERROR = () => 'Cannot disconnect the only connected authentication method.';
export const MANDATORY_FIELDS_ERROR = () => 'Mandatory fields cannot be empty';
export const FORM_LOGIN_DESC = () => 'Enable your workspace to sign in with Appsmith Form.';
export const GOOGLE_AUTH_DESC = () => 'Enable your workspace to sign in with Google (OAuth 2.0) single sign-on (SSO).';
export const GITHUB_AUTH_DESC = () => 'Enable your workspace to sign in with GitHub (OAuth 2.0) single sign-on (SSO).';
export const SAML_AUTH_DESC = () => 'Enable your workspace to sign in with your preferred SAML2 compliant provider.';
export const OIDC_AUTH_DESC = () => 'Enable your workspace to sign in with your preferred OIDC compliant provider.';
...
export const INTRODUCING = (featureName: string) => `Introducing ${featureName}`;
...
export const SECURITY_AND_COMPLIANCE_DETAIL2 = () => 'Exports to popular compliance tools coming soon';
...
export const GRANULAR_ACCESS_CONTROL_FOR_TEAMS = () => 'granular access controls for teams';
...
export const SECURITY_APPS_LEAST_PRIVILEGE = () => 'Secure apps by the least privilege needed';
...
export const PREVENT_ACCIDENTAL_DAMAGE = () => 'Prevent accidental damage to data';
...
export const RESTRICT_PUBLIC_EXPOSURE = () => 'Restrict public exposure of sensitive data';
...
export const USER_PROVISIONING_FOR_ENTERPRISES = () => 'Manage Appsmith users via your identity provider';
...
export const PROVISION_DEPROVISION_USERS = () => 'Provision and deprovision users from your IdP';
...
//
export const WELCOME_FORM_NON_SUPER_USER_ROLE_DROPDOWN = () => 'Tell us about your primary skillset';
export const WELCOME_FORM_NON_SUPER_USER_ROLE = () => 'Role';
export const WELCOME_FORM_NON_SUPER_USER_USE_CASE = () => 'What would you like to use Appsmith for?';
export const WELCOME_FORM_NON_SUPER_USER_PROFICIENCY_LEVEL = () => 'What is your general development proficiency?';

export const WELCOME_FORM_PROFICIENCY_ERROR_MESSAGE = () => 'Please select a proficiency level';
export const WELCOME_FORM_USE_CASE_ERROR_MESSAGE = () => 'Please select an use case';

export const WELCOME_FORM_EMAIL_ERROR_MESSAGE = () => 'Enter a valid email address.';

export const WELCOME_FORM_STRONG_PASSWORD_ERROR_MESSAGE = () => 'Please enter a strong password.';

export const WELCOME_FORM_GENERIC_ERROR_MESSAGE = () => 'This field is required.';

export const WELCOME_FORM_PASSWORDS_NOT_MATCHING_ERROR_MESSAGE = () => "Passwords don't match.";

export const QUERY_CONFIRMATION_MODAL_MESSAGE = () => `Are you sure you want to run `;
export const ENTITY_EXPLORER_TITLE = () => 'NAVIGATION';
export const MULTI_SELECT_PROPERTY_PANE_MESSAGE = () => `Select a widget to see it's properties`;
...
export const JS_TOGGLE_SWITCH_JS_MESSAGE = 'Switch to JS mode to customize your data using javascript';
export const PROPERTY_PANE_EMPTY_SEARCH_RESULT_MESSAGE = 'No properties found based on your search';
export const PROPERTY_SEARCH_INPUT_PLACEHOLDER = 'Search for controls, labels etc';
...
export const DELETE_WORKSPACE_SUCCESSFUL = () => 'Workspace deleted successfully';
// theming
...
export const DELETE_APP_THEME_WARNING = () => `Do you really want to delete this theme? This process cannot be undone.`;
...
export const ADMIN_AUTH_SETTINGS_SUBTITLE = () => 'Select a protocol you want to authenticate users with';
...
// Branding
export const ADMIN_BRANDING_SETTINGS_TITLE_UPGRADE = () => 'Custom Branding for your workspaces';
...
export const ADMIN_BRANDING_LOGO_SIZE_ERROR = () => `Uploaded file must be less than 2MB`;
export const ADMIN_BRANDING_LOGO_DIMENSION_ERROR = () => `Logo should  be atleast 256px in height`;
export const ADMIN_BRANDING_LOGO_FORMAT_ERROR = () => `Uploaded file must be in .SVG .PNG, and .JPG formats`;
export const ADMIN_BRANDING_LOGO_REQUIREMENT = () => `.SVG, .PNG, or .JPG only • Max 2MB`;
export const ADMIN_BRANDING_FAVICON_DIMENSION_ERROR = () => `Uploaded file must have a max size of 32X32 pixels`;
export const ADMIN_BRANDING_FAVICON_SIZE_ERROR = () => `Uploaded file must be less than 2MB`;
export const ADMIN_BRANDING_FAVICON_FORMAT_ERROR = () => `Uploaded file must be in .ICO, .PNG, and .JPG formats`;
export const ADMIN_BRANDING_FAVICON_REQUIREMENT = () => `.ICO, .PNG, or .JPG only • Max 32X32`;
export const ADMIN_BRANDING_COLOR_TOOLTIP_PRIMARY = () => `Used on buttons, links, and other interactive elements.`;
export const ADMIN_BRANDING_COLOR_TOOLTIP_BACKGROUND = () => `Used as background color for the auth pages`;
export const ADMIN_BRANDING_COLOR_TOOLTIP_HOVER = () => `Used as hover color for the button.`;
export const ADMIN_BRANDING_COLOR_TOOLTIP_FONT = () => `Used as text color for the buttons.`;
export const ADMIN_BRANDING_COLOR_TOOLTIP_DISABLED = () => `Used as background color for disabled buttons.`;
...
export const STEP_THREE_TITLE = () => 'Display the response of the query in a table.';
...
export const STEP_FOUR_TITLE = () => 'Let’s build a form to update a customer record ';
...
export const STEP_FIVE_TITLE = () => 'Connect all input fields in the Customer Update Form with the table';
export const STEP_FIVE_HINT_TEXT = () =>
  `Now let's connect rest of widgets in the container to the table's selected row`;
export const STEP_FIVE_SUCCESS_TEXT = () => 'Great work! All inputs are now connected to the table’s selected row';
export const STEP_FIVE_SUCCESS_BUTTON_TEXT = () => 'Proceed to next step';
export const STEP_SIX_TITLE = () => 'Add an update button to trigger an update query';
export const STEP_SIX_SUCCESS_TEXT = () => 'Perfect! Your update button is ready to trigger an update query.';
export const STEP_SIX_SUCCESS_BUTTON_TEXT = () => 'Proceed to next step';
export const STEP_SEVEN_TITLE = () => 'Trigger updateCustomerInfo query by binding to the button widget';
...
// -- Intro content --
export const TITLE = () => 'In this tutorial we’ll build a tool to display customer information';
...
// -- Rating --
export const RATING_TITLE = () => 'Congratulations! You just built your first app in Appsmith.';
export const RATING_DESCRIPTION = () => 'You can now invite others to this application.';
export const RATING_TEXT = () => 'Rate your experience';
// -- End Message --
export const END_TITLE = () => 'What’s next? Start building your own apps.';
export const END_DESCRIPTION = () => 'Inspect properties of queries, components, etc.';
...
export const COULDNT_FIND_TEMPLATE = () => 'Couldn’t find what you are looking for?';
...
export const SKIP_START_WITH_USE_CASE_TEMPLATES = () => 'Skip this step, I’ll do it later';
...
export const ENTITY_ID_TOOLTIP = () => "This URL will be used while configuring your Identity Provider's Entity ID URL";

export const FORK_APP_MODAL_LOADING_TITLE = () => 'Fetching workspaces to fork to...';
export const FORK_APP_MODAL_EMPTY_TITLE = () => 'No workspace available to fork to';
export const FORK_APP_MODAL_SUCCESS_TITLE = () => 'Choose where to fork the app';
...
export const INVALID_URL = () => 'Please enter a valid URL, for example, https://example.com';
...
export const GENERAL_SETTINGS_SECTION_HEADER_DESC = () => 'App name, icon and share';
export const GENERAL_SETTINGS_APP_NAME_LABEL = () => 'App name';
export const GENERAL_SETTINGS_NAME_EMPTY_MESSAGE = () => 'App name cannot be empty';
export const GENERAL_SETTINGS_NAME_SPECIAL_CHARACTER_ERROR = () => "Only alphanumeric or '-()' are allowed";
...
export const THEME_SETTINGS_SECTION_HEADER_DESC = () => 'Set theme, color and font';
...
export const PAGE_SETTINGS_NAME_EMPTY_MESSAGE = () => 'Page name cannot be empty';
export const PAGE_SETTINGS_NAME_SPECIAL_CHARACTER_ERROR = () => "Only alphanumeric or '-' are allowed";
...
export const PAGE_SETTINGS_PAGE_URL_VERSION_UPDATE_3 = () => 'your app URL to the new format to set the page URL.';
export const PAGE_SETTINGS_SHOW_PAGE_NAV = () => 'Show page navigation';
export const PAGE_SETTINGS_SHOW_PAGE_NAV_TOOLTIP = () => 'Show or hide the page in the appsmith navbar in view mode';
...
export const PAGE_SETTINGS_ACTION_NAME_CONFLICT_ERROR = (name: string) => `${name} is already being used.`;
...
export const IN_APP_EMBED_SETTING = {
  ...
  allowEmbeddingTooltip: () => 'This app can be embedded in all domains, including malicious ones',
  ...
  disableEmbeddingTooltip: () => 'This app cannot be embedded anywhere on the internet',
  embed: () => 'Embed',
  ...
  forkLabelTooltip: () => 'Forking allows developers to copy your app to their workspace',
  upgradeHeading: () =>
  ...
  rampSubtextSidebar: () => 'To embed private Appsmith apps and seamlessly authenticate users through SSO, try our ',
...
export const APP_NAVIGATION_SETTING = {
  ...
  showSignInTooltip: () => 'Toggle to show the sign-in button for users who are not logged in.',
...
export const DATASOURCE_INTERCOM_TEXT = () => 'Do you need help setting up a Google Sheets datasource?';
export const GOOGLE_SHEETS_ASK_FOR_SUPPORT = () => 'Ask for support';
export const GOOGLE_SHEETS_FILE_PICKER_TITLE = () => 'Select Google Sheets to query';
...
export const SAVE_SNAPSHOT = () => 'Save a snapshot of your current layout for 5 days';
...
export const DISCARD_SNAPSHOT_TEXT = () => 'You are about to discard this snapshot:';
export const CONVERSION_SUCCESS_TEXT = () => 'Check all your pages and start using your new layout';
export const CONVERSION_WARNING_HEADER = () => 'All done, some adjustments needed';
...
export const CONVERSION_ERROR = () => 'Appsmith ran into a critical error while trying to convert to auto-layout';
...
export const SNAPSHOT_LABEL = () => 'To revert back to the original state use this snapshot';
...
export const SNAPSHOT_WARNING_MESSAGE = () => 'Any changes you made after conversion will not be present.';
...
export const CONVERSION_ERROR_MESSAGE_HEADER = () => 'To resolve this error please:';
export const CONVERSION_ERROR_MESSAGE_TEXT_ONE = () => 'Check your internet connection.';
...
export const SNAPSHOT_TIME_FROM_MESSAGE = (timeSince: string, readableDate: string) =>
  `Snapshot from ${timeSince} ago (${readableDate})`;
export const SNAPSHOT_TIME_TILL_EXPIRATION_MESSAGE = (timeTillExpiration: string) =>
...
export const SWITCH_ENV_DISABLED_TOOLTIP_TEXT = (): string => 'To access environments for datasources, try out our ';

export const TEST_DATASOURCE_SUCCESS = (datasourceName: string, environmentName: string) => {
...
export const TEST_DATASOURCE_ERROR = () => "Test failed, couldn't establish a connection";
...
export const EDIT_FIELDS_DISABLED_TOOLTIP_TEXT = () => 'Select a table to edit fields';

export const SAVE_CHANGES_DISABLED_TOOLTIP_TEXT = () => 'You have to select at least 1 field to save';

export const NO_CONNECTABLE_WIDGET_FOUND = () => 'Add a table or list widget with data to get the values from';
...
export const COMMUNITY_TEMPLATES = {
  ...
  publishSuccessPage: {
    ...
    description: () => 'This application is live on community as a template for users to fork and remix.',
  ...
  publishFormPage: {
    ...
    publishedInfo: {
      ...
      correct: [() => 'Widgets & their properties', () => 'Queries & JS Objects', () => 'Datasource types'],
      incorrect: [
  ...
  modals: {
    unpublishedInfo: {
      ...
      description: () => 'Publish this app to Appsmith community for the public to view, fork, and remix.',
...
export const EMPTY_TABLE_MESSAGE_TEXT = () => 'There are no data records to show';
...
export const DATASOURCE_LIST_BLANK_DESCRIPTION = () => 'Connect a datasource to write your first query';
...
export const EDITOR_PANE_TEXTS = {
  ...
  query_blank_state_description: () => 'Write your first query or API to access data',
  js_blank_state_description: () => 'Use JS to transform your data or write business logic',
  widget_blank_state_description: () => 'Drag & drop UI elements to create your app',
...
export const CUSTOM_WIDGET_FEATURE = {
  ...
  template: {
    modal: {
      header: () => 'Are you sure?',
      body: () => 'This will replace the current changes in the HTML, CSS and JS files.',
      successCTA: () => 'Replace',
      cancelCTA: () => 'Cancel',
    },
    buttonCTA: () => 'Templates',
...
export const WIDGET_PANEL_EMPTY_MESSAGE = () => 'We couldn’t find any UI elements called';
...
export const MAXIMIZE_BUTTON_TOOLTIP = () => `Expand code editor to full-screen`;
